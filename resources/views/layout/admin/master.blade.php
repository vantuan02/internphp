...
<head>
    ...
    <!-- Daterange picker -->
    <link rel="stylesheet" href="source/plugins/daterangepicker/daterangepicker-bs3.css">
  ...
  <![endif]-->
    ...
    <!-- ./wrapper -->
    <!-- jQuery 2.2.0 -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.0.0/jquery.min.js" integrity="sha512-lzilC+JFd6YV8+vQRNRtU7DOqv5Sa9Ek53lXt/k91HZTJpytHS1L6l1mMKR9K6VVoDt4LiEXaa6XBrYk1YhGTQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>    {{-- <script src="source/plugins/jQuery/jQuery-2.2.0.min.js"></script> --}}
