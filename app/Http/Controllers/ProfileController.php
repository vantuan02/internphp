...
class ProfileController extends Controller
{
    ...
    public function showRegisterSubjects()
    {
        ...
        return view("student.registerSubject", compact("subjects", "student"));
    }

    public function registerSubjects($id)
    {
        $this->studentRepository->registerSubjects($id);
        return redirect()->route("students.registerSubject")->with("success", "Register course successfully!");
    }

    public function registerListSubjects(Request $request)
    {
        $this->studentRepository->registerSubjects($request->input("listSubjectsCheckbox"));
